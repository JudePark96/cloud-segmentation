...
class AtrousConvolutionBlock(nn.Module):
    ...
    def __init__(self, in_channel: int, output_channel: int, num_classes):
        ...
        self.conv_3x3_4 = nn.Conv2d(self.in_channel, self.out_channel, kernel_size=3, stride=1, padding=12, dilation=12)
        self.bn_conv_3x3_4 = nn.BatchNorm2d(self.out_channel)
        ...
        self.conv_1x1_3 = nn.Conv2d(6 * self.out_channel, self.out_channel, kernel_size=1)
    ...
    def forward(self, feature_map):
        ...
        out_3x3_4 = F.relu(self.bn_conv_3x3_4(self.conv_3x3_4(feature_map)))

        out_img = self.max_pool(feature_map)
        out_img = F.relu(self.bn_conv_1x1_2(self.conv_1x1_2(out_img)))
        out_img = F.interpolate(out_img, size=(feature_map_h, feature_map_w), align_corners=True, mode='bilinear')

        print(f'{[out.shape for out in [out_1x1, out_3x3_1, out_3x3_2, out_3x3_3, out_3x3_4, out_img]]}')

        out = torch.cat([out_1x1, out_3x3_1, out_3x3_2, out_3x3_3, out_3x3_4, out_img], 1)
